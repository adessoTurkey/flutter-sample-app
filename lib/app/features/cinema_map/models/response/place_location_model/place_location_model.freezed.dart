...
abstract class $PlaceLocationModelCopyWith<$Res> {
  factory $PlaceLocationModelCopyWith(
          PlaceLocationModel value, $Res Function(PlaceLocationModel) then) =
...
abstract class _$$PlaceLocationModelImplCopyWith<$Res>
    implements $PlaceLocationModelCopyWith<$Res> {
  factory _$$PlaceLocationModelImplCopyWith(_$PlaceLocationModelImpl value,
...
class __$$PlaceLocationModelImplCopyWithImpl<$Res>
  ...
  __$$PlaceLocationModelImplCopyWithImpl(_$PlaceLocationModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PlaceLocationModelImpl(
      latitude: freezed == latitude
          ? _value.latitude
          : latitude // ignore: cast_nullable_to_non_nullable
              as double?,
...
class _$PlaceLocationModelImpl implements _PlaceLocationModel {
  const _$PlaceLocationModelImpl({this.latitude, this.longitude});
  ...
  @override
  String toString() {
    return 'PlaceLocationModel(latitude: $latitude, longitude: $longitude)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PlaceLocationModelImplToJson(
      this,
    );
  }
}
...
abstract class _PlaceLocationModel implements PlaceLocationModel {
  const factory _PlaceLocationModel(
      {final double? latitude,
      final double? longitude}) = _$PlaceLocationModelImpl;
