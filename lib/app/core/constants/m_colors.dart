...
abstract final class MColors {
  static const Color electricBlue = Color(0xff0146ff);
  static const Color almostBlack = Color(0xff08090a);
  ...
  static const Color mainPageBackgroundColor =Color(0xFFECEFF1);
}